...
fun main() {
    ...
    val filePathTrain =
        "D:\\repo\\AI4kt\\data\\classification\\MNIST\\mnist_train.csv" // Update this path to your dataset location
    val filePathTest =
        "D:\\repo\\AI4kt\\data\\classification\\MNIST\\mnist_test.csv" // Update this path to your dataset location
